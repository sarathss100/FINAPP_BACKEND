...
const account_validation_1 = __importDefault(require("validation/accounts/account.validation"));
    ...
    addAccount(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const parsedBody = account_validation_1.default.safeParse(formData);
    ...
    updateAccount(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const partialaccountsDTOSchema = account_validation_1.default.partial();
