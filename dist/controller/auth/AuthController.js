    ...
    verifyToken(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userDetails = yield this._authService.getUserDetails(accessToken);
                (0, responseHandler_1.sendSuccessResponse)(response, statusCodes_1.StatusCodes.OK, successMessages_1.SuccessMessages.TOKEN_VERIFIED, { valid: true, status: verificationStatus.status, subscription_status: userDetails.subscription_status });
            }
            catch (error) {
                if (error instanceof AppError_2.AppError) {
                    (0, responseHandler_1.sendErrorResponse)(response, error.statusCode, error.message);
