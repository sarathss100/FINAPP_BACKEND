...
const insurance_validation_1 = require("validation/insurances/insurance.validation");
/**
    ...
    createInsurance(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const dto = insurance_validation_1.insuranceDTOSchema.parse(request.body.formData);
