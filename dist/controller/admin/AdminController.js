...
const FaqDto_1 = __importDefault(require("../../dtos/base/FaqDto"));
    ...
    addFaq(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const parsedData = FaqDto_1.default.safeParse(request.body);
    ...
    getAllFaqsForAdmin(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const faqDetails = yield this._adminService.getAllFaqsForAdmin();
                if (faqDetails) {
