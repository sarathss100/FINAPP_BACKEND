...
const TransactionDto_1 = __importDefault(require("dtos/transaction/TransactionDto"));
            ...
            try {
                ...
                if (isArray) {
                    ...
                    for (let i = 0; i < request.body.length; i++) {
                        const parsedTransaction = TransactionDto_1.default.safeParse(request.body[i]);
                    ...
                    const parsedBody = TransactionDto_1.default.safeParse(request.body);
