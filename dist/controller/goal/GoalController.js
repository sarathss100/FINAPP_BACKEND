...
const goal_validation_1 = __importDefault(require("validation/goal/goal.validation"));
class GoalController {
    ...
    createGoal(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const parsedBody = goal_validation_1.default.safeParse(request.body);
    ...
    updateGoal(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const partialGoalDTOSchema = goal_validation_1.default.partial();
                // Validate the request body using the Zod schema
    ...
    getTotalInitialGoalAmount(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { accessToken } = request.cookies;
                if (!accessToken) {
                ...
                // Call the service layer to get the user goals
                const totalInitialGoalAmount = yield this._goalService.getTotalInitialGoalAmount(accessToken);
                (0, responseHandler_1.sendSuccessResponse)(response, statusCodes_1.StatusCodes.OK, successMessages_1.SuccessMessages.GOALS_RETRIEVED, { totalInitialGoalAmount });
            }
            catch (error) {
                if (error instanceof AppError_1.AppError) {
                    (0, responseHandler_1.sendErrorResponse)(response, error.statusCode, error.message);
