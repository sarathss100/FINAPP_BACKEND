...
const registerInvestmentsHandlers = function (io, socket) {
    ...
    try {
        ...
        socket.on('request_all_investments', () => __awaiter(this, void 0, void 0, function* () {
            try {
                const investments = yield investmentService.getCategorizedInvestments(accessToken);
        ...
        socket.on('request_total_invested_amount', () => __awaiter(this, void 0, void 0, function* () {
            try {
                const totalInvestedAmount = yield investmentService.totalInvestment(accessToken);
        ...
        socket.on('request_current_valuation', () => __awaiter(this, void 0, void 0, function* () {
            try {
                const totalCurrentValuation = yield investmentService.currentTotalValue(accessToken);
        ...
        socket.on('request_total_returns', () => __awaiter(this, void 0, void 0, function* () {
            try {
                const totalReturns = yield investmentService.getTotalReturns(accessToken);
...
exports.default = registerInvestmentsHandlers;
