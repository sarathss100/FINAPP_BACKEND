...
exports.createGeminiPrompt = exports.parseGeminiResponse = void 0;
/**
* Parses the Gemini API response
*/
const parseGeminiResponse = function (response) {
    try {
...
/**
     ...
     */
const formatGoalsForGemini = function (goals) {
    return goals
...
/**
     ...
     */
const createGeminiPrompt = function (goals) {
...
exports.createGeminiPrompt = createGeminiPrompt;
