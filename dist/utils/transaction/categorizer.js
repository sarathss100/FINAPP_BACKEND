...
exports.classify = exports.SMART_CATEGORY_REGEX_MAP = void 0;
const ITransaction_1 = require("model/transaction/interfaces/ITransaction");
exports.SMART_CATEGORY_REGEX_MAP = {
    // Income Categories
    SALARY: [
...
const classify = function (description, transactionType) {
    if (!description)
        return 'MISCELLANEOUS';
    const lowerDesc = description.toLowerCase();
    for (const smart_category of ITransaction_1.SMART_CATEGORIES) {
        const patterns = exports.SMART_CATEGORY_REGEX_MAP[smart_category] || [];
