 ...
 */
const calculateBondProfitOrLoss = function (bondData) {
    // Destructure bond data with defaults
    const { faceValue = 100, couponRate = 0, initialAmount = 0, purchaseDate, } = bondData;
...
exports.default = calculateBondProfitOrLoss;
