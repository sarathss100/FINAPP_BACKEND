...
const ResetPasswordDto_1 = require("dtos/auth/ResetPasswordDto");
...
class AuthService {
    ...
    signup(signupData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                SignupDto_1.SignupSchema.parse(signupData);
    ...
    signin(signinData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Validate signup data
                SigninDto_1.SigninSchema.parse(signinData);
    ...
    resetPassword(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Validate the data
                ResetPasswordDto_1.ResetPasswordSchema.parse(data);
