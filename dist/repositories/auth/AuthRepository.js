        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const refinedUserDetails = {
                    ...
                    status: (user === null || user === void 0 ? void 0 : user.status) || false,
                    is2FA: (user === null || user === void 0 ? void 0 : user.is2FA) || false,
                    isDeleted: (user === null || user === void 0 ? void 0 : user.isDeleted) || false,
                    subscription_status: (user === null || user === void 0 ? void 0 : user.subscription_status) || false
                };
