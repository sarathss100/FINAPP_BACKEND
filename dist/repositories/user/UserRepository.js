...
class UserRepository extends UserBaseRespository_1.default {
    ...
    findByUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user)
                return null;
            return { userId: user.id, firstName: user.first_name, lastName: user.last_name, phoneNumber: user.phone_number, is2FA: user.is2FA, subscription_status: user.subscription_status, profilePictureUrl: user.profile_picture_url };
        });
    }
