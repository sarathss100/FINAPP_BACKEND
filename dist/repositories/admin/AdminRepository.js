...
class AdminRepository {
    ...
    findAllUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            const users = yield UserModel_1.UserModel.find({ role: 'user' }).lean();
    ...
    getAllFaqsForAdmin() {
        return __awaiter(this, arguments, void 0, function* (page = 1, limit = 10, search = '') {
            try {
                ...
                const totalItems = yield FaqModel_1.FaqModel.countDocuments(query);
                const totalPages = Math.ceil(totalItems / limit);
                const faqDetails = yield FaqModel_1.FaqModel.find(query)
                    .sort({ updatedAt: -1 })
                    .skip((page - 1) * limit)
                    .limit(limit);
                const pagination = {
